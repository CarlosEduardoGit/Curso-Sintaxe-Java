...
Na linguagem de programação, sintaxe corresponde as regras de escrita dos comandos de texto.

Dentro da programação existe ainda o termo chamado semântica que mostra o significado associado dessas frases.

#### Para que serve?

Serve para que os termos da linguagem sejam corretamente interpretados pelo computador e consequentemente executados, ou seja, 
trata da estrutura de um programa escrito em código, envolvendo o conjunto de frases permitidas de uma linguagem.
